...
**(h)** The mean of your simulated values of $\hat{\beta}_0$ is **3.09209**, given the answer in f, yes this does make sense.

```{r}
mean(beta_hat$beta_hat_0)
```

**(i)** The standard deviation of your simulated values of $\hat{\beta}_0$ is **1.510165** given the answer in g, yes this does make sense.
